...
var ResultPanel = (function (_super) {
    ...
    function ResultPanel() {
        ...
        _this.skinName = ResultPanelSkin;
        return _this;
    }
    ResultPanel.prototype.OnOpen = function () {
        var _this = this;
        ...
        egret.Tween.get(this.tipLB).wait(100).to({ verticalCenter: -340 }, 700)
            .call(function () {
            _this.yesBtn.visible = true;
        });
    };
    ResultPanel.prototype.OnClose = function () {
        _super.prototype.OnClose.call(this);
    };
    ResultPanel.prototype.Open = function (layer, rsl) {
        return __awaiter(this, void 0, void 0, function () {
            var _this = this;
            return __generator(this, function (_a) {
                return [2 /*return*/, new Promise(function (resolve, reject) {
                        _this._rsl = rsl;
                        _super.prototype.Open.call(_this, layer);
    ...
    ResultPanel.Show = function (rsl) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, App.panel.result.Open(App.layer.tipLayer, rsl)];
            });
        });
    };
    ResultPanel.StateVic = "vic";
    ResultPanel.StateDef = "def";
    return ResultPanel;
}(UIBase));
